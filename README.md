...
**Note:** the last command *may* take up to [`20mins`](http://www.raspberrypi.org/forums/viewtopic.php?f=66&t=21995#p309093). The above execution of copying the raspbian image, [`pv`](http://linux.die.net/man/1/pv) had a transfer range of roughly `3.9-5.23MiB/s`.
